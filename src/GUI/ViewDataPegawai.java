 ...
 * @author ASUS
 */
public class ViewDataPegawai extends javax.swing.JApplet {

    /**
     * Initializes the applet ViewDataPegawai
     */
    @Override
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDataPegawai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
